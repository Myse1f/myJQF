...
class DataLoader:
	...
	generators = ['quickcheck', 'zest', 'automata']
	validity = ['closure', 'rhino', 'fastjson', 'gson']
	...
	def get_data(self, base_dirname, time):
		dirnames = [base_dirname + "-{}".format(i+1) for i in range(0,time) ]
